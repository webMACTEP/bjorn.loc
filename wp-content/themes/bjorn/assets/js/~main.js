...
$('#whatsapp__link img').hover(function(){
   $(this).attr('src', 'http://bjorn-motors.ru/wp-content/themes/bjorn/assets/img/header/whatsapp-hover.svg');
},function(){
   $(this).attr('src', 'http://bjorn-motors.ru/wp-content/themes/bjorn/assets/img/header/whatsapp.svg');
});
$('#telegram__link img').hover(function(){
   $(this).attr('src', 'http://bjorn-motors.ru/wp-content/themes/bjorn/assets/img/header/telegram-hover.svg');
},function(){
   $(this).attr('src', 'http://bjorn-motors.ru/wp-content/themes/bjorn/assets/img/header/telegram.svg');
});
$('#viber__link img').hover(function(){
   $(this).attr('src', 'http://bjorn-motors.ru/wp-content/themes/bjorn/assets/img/header/viber-hover.svg');
},function(){
   $(this).attr('src', 'http://bjorn-motors.ru/wp-content/themes/bjorn/assets/img/header/viber.svg');
});
$('#instagram__link img').hover(function(){
   $(this).attr('src', 'http://bjorn-motors.ru/wp-content/themes/bjorn/assets/img/header/instagram-hover.svg');
},function(){
   $(this).attr('src', 'http://bjorn-motors.ru/wp-content/themes/bjorn/assets/img/header/instagram.svg');
});
$('.fancy__play').hover(function(){
   $(this).attr('src', 'http://bjorn-motors.ru/wp-content/themes/bjorn/assets/img/icons/play-hover.svg');
},function(){
   $(this).attr('src', 'http://bjorn-motors.ru/wp-content/themes/bjorn/assets/img/icons/play.svg');
});
$('.footer__youtube').hover(function(){
   $(this).attr('src', 'http://bjorn-motors.ru/wp-content/themes/bjorn/assets/img/icons/youtube-hover.svg');
},function(){
   $(this).attr('src', 'http://bjorn-motors.ru/wp-content/themes/bjorn/assets/img/icons/youtube.svg');
});
$('.footer__instagram').hover(function(){
   $(this).attr('src', 'http://bjorn-motors.ru/wp-content/themes/bjorn/assets/img/icons/instagram-hover.svg');
},function(){
   $(this).attr('src', 'http://bjorn-motors.ru/wp-content/themes/bjorn/assets/img/icons/instagram.svg');
});

$('.footer__facebook').hover(function(){
   $(this).attr('src', 'http://bjorn-motors.ru/wp-content/themes/bjorn/assets/img/icons/facebook-hover.svg');
},function(){
   $(this).attr('src', 'http://bjorn-motors.ru/wp-content/themes/bjorn/assets/img/icons/facebook.svg');
});

$('.footer__vk').hover(function(){
   $(this).attr('src', 'http://bjorn-motors.ru/wp-content/themes/bjorn/assets/img/icons/vk-hover.svg');
},function(){
   $(this).attr('src', 'http://bjorn-motors.ru/wp-content/themes/bjorn/assets/img/icons/vk.svg');
});
