...
?>
          ...
          <div class="services__flex">
            ...
            <form action="" class="services__form" method="post" autocomplete="off">
              <div class="services__form__wrapp">
                ...
                <button onclick="ym(68416318,'reachGoal','uznat'); return true;" class="services__form__btn" type="submit">
  ...
  <section class="sale" id="sale">
    <div class="container">
        ...
        <div class="col-12">
          <div class="sale__top">
            <div class="sale__left">
              <div class="sale__left__title"><?php the_field("akciya_m_title");?></div>
              <div class="sale__left__subtitle"><?php the_field("akciya_m_subtitle");?></div>
            ...
            <div class="sale__right">
              <img src="<?php the_field("akciya_m_img");?>" class="sale__right__img">
            </div>
          </div>
        </div>
      </div>
      <div class="row sale__bottom">
        <div class="col-12">
          <div class="sale__title"><?php the_field("akcii_title");?></div>
          <div class="sale__subtitle"><?php the_field("akcii_subtitle");?></div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-12">
          <form action="" class="feedback__form" method="post" autocomplete="off">
            ...
            <button onclick="ym(68416318,'reachGoal','predlogheniya'); return true;" class="feedback__form__btn" type="submit">Отправить</button>
          </form>
        </div>
      </div>
    </div>
  ...
  <section class="contacts" id="contacts">
    ...
    <iframe src="https://yandex.ru/map-widget/v1/?um=constructor%3Ad2471f5b700d1690678c440ebd1fa15bd17465d2e471e492f1c5fc55160da345&amp;source=constructor;scroll=false;" width="100%" height="400" frameborder="0" class="contacts__map"></iframe>
  </section>
