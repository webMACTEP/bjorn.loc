...
<head>
  ...
  <noscript>
    <div><img src="https://mc.yandex.ru/watch/68416318" style="position:absolute; left:-9999px;" alt="" /></div>
  </noscript>
  <!-- /Yandex.Metrika counter -->
...
<body class="body">
  ...
  <header class="header" id="header">
    ...
    if ($is_mobile_device) {  //if (isset($_GET['width']) )  {
      ...
      echo '<img src="' . bjorn_get_image('icons/callback.svg') . '" class="callback-btn">';
    }
    ?>
  </header>
  <nav class="main-menu">
